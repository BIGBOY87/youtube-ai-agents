...
class YouTubeClient:
    def __init__(self):
        self.api_key=os.getenv("YOUTUBE_API_KEY",""); self.channel_id=os.getenv("YOUTUBE_CHANNEL_ID",""); self.base="https://www.googleapis.com/youtube/v3"
    ...
    def recent_videos(self,max_results=12,channel_id=None):
        cid=channel_id or self.channel_id
        s=self._get("/search",{"part":"snippet","channelId":cid,"order":"date","maxResults":max_results,"type":"video"})
